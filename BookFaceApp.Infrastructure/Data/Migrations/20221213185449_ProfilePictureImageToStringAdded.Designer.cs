...
namespace BookFaceApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20221213185449_ProfilePictureImageToStringAdded")]
    partial class ProfilePictureImageToStringAdded
    {
            ...
            modelBuilder.Entity("BookFaceApp.Infrastructure.Data.Entities.ProfilePicture", b =>
                {
                    ...
                    b.Property<string>("ImageToString")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BookFaceApp.Infrastructure.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2f54a522-ea7d-4f27-a009-6ef85259aad2",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHVkRpgxRHBp+VtUhp3iufh2GquXeWemFLB9DlEjJS3OGMCOfeFM246q5gx/Q+y73Q==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a64f5b8d-ca1e-4ec8-8444-7bf6dfff8024",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "861e6eb9-1614-4508-8fab-84175df7c6ef",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMPZ0yNSNczFkGk//vWXNkGlDQPgMmJPwY3uIhpS4yDOEyDyY17JIc7lLj49k+OJsQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d6fa7372-beca-427d-b218-366c98be7162",
                            TwoFactorEnabled = false,
                            UserName = "Guest"
                        });
                });
            ...
            modelBuilder.Entity("BookFaceApp.Infrastructure.Data.Entities.ProfilePicture", b =>
                {
                    b.HasOne("BookFaceApp.Infrastructure.Data.Entities.User", null)
                        ...
                        .HasForeignKey("BookFaceApp.Infrastructure.Data.Entities.ProfilePicture", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
