...
namespace BookFaceApp.UnitTests
{
	...
	public class PublicationServiceTests
	{
		...
		[Test]
		public async Task EditPublicationShouldThrowIfInvalidModelIsPassed()
		{
			var service = serviceProvider.GetService<IPublicationService>();
		...
		public async Task GetAllPublicationsShouldWorkCorrectly()
		{
			...
			var expectedPublicationsCount = 1;
		...
		[Test]
		public void GetOnePubShouldNotThrow()
		{
			var service = serviceProvider.GetService<IPublicationService>();

			Assert.DoesNotThrowAsync(async () => await service.GetOnePublicationAsync(1));
		}
		...
		[Test]
		public void GetPublicationForEditShouldNowThrow()
		{
			var service = serviceProvider.GetService<IPublicationService>();
		...
		public async Task DeletePublicationShouldWorkCorrectly()
		{
			...
			Assert.IsTrue(publicationBeforeDelete != null);
